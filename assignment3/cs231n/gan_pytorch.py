...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    loss = 0.5 * torch.mean((scores_real - torch.ones(N).type(dtype)) ** 2 + scores_fake ** 2)
...
def test():
    ...
    images = run_a_gan(D_DC, G_DC, D_DC_solver, G_DC_solver, discriminator_loss, generator_loss, loader_train,
                       num_epochs=5)
test()